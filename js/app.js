...
document.addEventListener('DOMContentLoaded', ()=>{
    ...
    formulario.addEventListener('submit', submitFormaulario)
...
function mostrarCotizacionHTML(cotizacion) {
    ...
    ultimasHoras.innerHTML=`Variacion ultimas 24hrs: <span>${CHANGEPCTHOUR}</span>`;

    const ultimaActualizacion = document.createElement('p'); 
    ultimaActualizacion.innerHTML=`Variacion ultimas 24hrs: <span>${LASTUPDATE}</span>`;
